...
//will only return active entries.
    public class Vendor
    {
        ...
        #endregion
        //http{ get; set; } ////vendor.qbapi.com/Vendor-C--Sample-Code.aspx
        // Summary{ get; set; } // Class representing the 'Vendor' object
// Quickbooks Online Vendor using REST API/SDK C# Example
// This sample is a C# sample application for Vendors
//
// This Source Code is open source and is for demonstration purposes only. Additional modifications are required to make it functional.
// Copyright (c) 2010-2015 qbapi.com. All Rights Reserved. 
...
//private bool UpdateVendor(Vendor Vendor)
//{
//Vendor.ContactName = "Contact Name Value";
//Vendor.AltContactName = "Alt Contact Name Value";
//Vendor.Notes = "Notes Value";
////Handle field Vendor.BillAddr (Type{ get; set; } // Intuit.Ipp.Data.PhysicalAddress);
////Handle field Vendor.ShipAddr (Type{ get; set; } // Intuit.Ipp.Data.PhysicalAddress);

//Quickbooks Recovery
//Ad www.quickbooksrepairpro.com/
//Guaranteed repair, or no charge!

////Handle field Vendor.OtherAddr (Type{ get; set; } // Intuit.Ipp.Data.PhysicalAddress[]);
//Vendor.TaxCountry = "Tax Country Value";
//Vendor.TaxIdentifier = "Tax Identifier Value";
//Vendor.BusinessNumber = "Business Number Value";

//Sage 50 to Quickbooks Data Migration
//Ad www.quickbooksrepairpro.com/
//Guaranteed Data Migration from Sage 50 to Quickbooks

////Set ParentRef (AnyIntuitObject) 
...
//};
//;
////Set VendorTypeRef (AnyIntuitObject) 
...
//};
//;
////Set PrefillAccountRef (AnyIntuitObject) 
...
//Vendor.Balance = 999.00;
////Set if Balance Specified
//Vendor.BalanceSpecified = true;
//Vendor.OpenBalanceDate = Convert.ToDate("12/31/2015");
////Set if Open Balance Date Specified
//Vendor.OpenBalanceDateSpecified = true;
////Set value for Credit Limit
//Vendor.CreditLimit = 999.00;
////Set if Credit Limit Specified
//Vendor.CreditLimitSpecified = true;
//Vendor.AcctNum = "Acct Num Value";
////Set if Vendor 1 0 9 9
//Vendor.Vendor1099 = true;
////Set if Vendor 1 0 9 9 Specified
//Vendor.Vendor1099Specified = true;
////Set if T 4 A Eligible
//Vendor.T4AEligible = true;
////Set if T 4 A Eligible Specified
//Vendor.T4AEligibleSpecified = true;
////Set if T 5 0 1 8 Eligible
//Vendor.T5018Eligible = true;
////Set if T 5 0 1 8 Eligible Specified
//Vendor.T5018EligibleSpecified = true;
////Set CurrencyRef (AnyIntuitObject) 
...
//};
//;
////Handle field Vendor.VendorEx (Type{ get; set; } // Intuit.Ipp.Data.IntuitAnyType);
//Vendor.IntuitId = "Intuit Id Value";
////Set if Organization
//Vendor.Organization = true;
////Set if Organization Specified
//Vendor.OrganizationSpecified = true;
//Vendor.Title = "Title Value";
//Vendor.GivenName = "Given Name Value";
//Vendor.MiddleName = "Middle Name Value";
//Vendor.FamilyName = "Family Name Value";
//Vendor.Suffix = "Suffix Value";
//Vendor.FullyQualifiedName = "Fully Qualified Name Value";
//Vendor.CompanyName = "Company Name Value";
//Vendor.DisplayName = "Display Name Value";
//Vendor.PrintOnCheckName = "Print On Check Name Value";
//Vendor.UserId = "User Id Value";
////Set if Active
//Vendor.Active = true;
////Set if Active Specified
//Vendor.ActiveSpecified = true;
////Handle field Vendor.PrimaryPhone (Type{ get; set; } // Intuit.Ipp.Data.TelephoneNumber);
////Handle field Vendor.AlternatePhone (Type{ get; set; } // Intuit.Ipp.Data.TelephoneNumber);
////Handle field Vendor.Mobile (Type{ get; set; } // Intuit.Ipp.Data.TelephoneNumber);
////Handle field Vendor.Fax (Type{ get; set; } // Intuit.Ipp.Data.TelephoneNumber);
////Handle field Vendor.PrimaryEmailAddr (Type{ get; set; } // Intuit.Ipp.Data.EmailAddress);
////Handle field Vendor.WebAddr (Type{ get; set; } // Intuit.Ipp.Data.WebSiteAddress);
////Handle field Vendor.OtherContactInfo (Type{ get; set; } // Intuit.Ipp.Data.ContactInfo[]);
////Set DefaultTaxCodeRef (AnyIntuitObject) 
...
////Handle field Vendor.CustomField (Type{ get; set; } // Intuit.Ipp.Data.CustomField[]);

//Vendor.domain = "domain Value";

////Set if status Specified
//Vendor.statusSpecified = true;
////Set if updating a subset of properties for a given object
//Vendor.sparse = true;
////Set if sparse Specified
//Vendor.sparseSpecified = true;
...
//private DataService ConnectToQBO() 
//{
//string accessToken = "";
