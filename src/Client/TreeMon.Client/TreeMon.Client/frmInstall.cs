...
namespace TreeMon.Client
{
    public partial class frmInstall : Form
    {
        ...
        //Install Step 1.
        public ServiceResult CreateConnectionString(AppInfo appSettings)
        {
        ...
        private void ValidateUserAccount(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrWhiteSpace(txtPassword.Text)) {
                this.txtErrors.Text = "Password cannot be blank!";
                return;
            }

            if (PasswordHash.IsCommonPassword(txtPassword.Text))
            {
                this.txtErrors.Text = "Easily hacked password!";
                return;
            }

            if (PasswordHash.CheckStrength(txtPassword.Text) < PasswordScore.Medium)
            {
                this.txtErrors.Text = "Password is WEAK!";
                return;
            }
            ...
            {
                this.txtErrors.Text = "Password doesn't match the confirmation password.";
                return;
            }
            ...
            {
                this.txtErrors.Text = "Password hint question or answer cannot be empty.";
                return;
            }
            ...
            {
                this.txtErrors.Text = "Hint answer cannot be the same as the question.";
                return;
            }
