...
.factory('User', function($q, $http, $localstorage, SERVER) {
      ...
      o.auth = function(username, signingUp) {
        ...
        var server = SERVER.url;//see .app.js
      ...
      o.signUp = function (form) {
          console.log('-----------------------------------------------------TODO fix ');
          InvokeRequestTest('post', SERVER.url + '/api/Account/Register', form);
         
          return o.setSession('bluesektor', '1234', '');
       
        //  return $http.post(server + '/api/Account/Register', form)
       //  .success(function (data) {
       //      o.setSession(data.username, data.session_id, data.favorites);
        // });
      }
...
function InvokeRequestTest(method, url, params) {
